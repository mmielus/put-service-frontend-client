...
import {castVote, getArchivedOffers} from '../util/APIUtils';
...
class ArchivedOffersList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offers: [],
    ...
    loadOfferList(page = 0, size = POLL_LIST_SIZE) {
        let promise;
        if (this.props.type === 'ARCHIVED_OFFERS') {
            promise = getArchivedOffers(page, size);
        }
...
export default withRouter(ArchivedOffersList);