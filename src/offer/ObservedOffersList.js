...
import {castVote, getObservedOffers} from '../util/APIUtils';
...
class ObservedOffersList extends Component {
    constructor(props) {
        super(props);
        this.state = {
            offers: [],
    ...
    loadOfferList(page = 0, size = POLL_LIST_SIZE) {
        let promise;
        if (this.props.type === 'OBSERVED_OFFERS') {
            promise = getObservedOffers(page, size);
        }
...
export default withRouter(ObservedOffersList);