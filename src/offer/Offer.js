        ...
        return (
            <div className="poll-content">
                <div className="poll-header">
                    ...
                    <div className="poll-question">
                        {this.props.poll.phoneNumber}
                    </div>
                    <div className="poll-question">
                        {this.props.poll.email}
                    </div>
                    <div className="poll-question">
                        {this.props.poll.city}
                    </div>
                    <div className="poll-question">
                        {this.props.poll.street}
                    </div>
                    <div className="poll-question">
                        {this.props.poll.houseNumber}
                    </div>
                    <div className="poll-question">
                        {this.props.poll.payment}
                    </div>


                </div>
                {/*<div className="poll-dimensions">*/}
                    {/*<RadioGroup*/}
